...
# net = SwinBlock(dim=96, heads=8, head_dim=32, mlp_dim=96 * 4, shifted=True, window_size=7, relative_pos_embedding=True)
# y = net(x)
# print(y.shape)
